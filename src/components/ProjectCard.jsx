            ...
            <figure key={project.id}>
                <Link href={`/project/${project.id}`} >
                    <div className="group relative  overflow-hidden rounded-md border border-[#282828]/20">
                        <img src={project.image} alt={project.name} className="w-full object-cover rounded-lg max-h-[700px]  shadow-sm transform transition duration-300 ease-in-out hover:scale-101" />
                    </div>
                </Link>
                <figcaption className="flex items-center  gap-8 py-4 ">
