        ...
        <>
            <div className="bg-[#F2F0EF] flex flex-col-reverse w-full mx-auto lg:flex-row quicksand-headerText justify-between max-w-[1440px] px-8 py-28 sm:py-38 gap-6 lg:gap-0">
                <motion.div initial={{ x: -50, opacity: 0 }}
                    ...
                    <h1 className="py-4 ">I’ve always loved admiring beautiful designs and wondering how they could come alive on screen.<br/>Now, with the skills i had from lesson. <br/> I'm excited to make it come to life.</h1>
